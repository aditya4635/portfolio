...
export const myProjects = [
  ...
  {
    title: 'Pdify',
    desc: 'Pdify is revolutionary software-as-a-Service platform that helps you create beautiful summaries of your pdf. With AI integration, it allows creators to generate diverse summaries based onn their plan selection.',
    subdesc:
      'Built as a unique Software-as-a-Service app with Nextjs, Tailwind CSS, typescript and zustang , Pdify is designed for optimal performance and scalability.',
    href: 'https://github.com/aditya4635/Ripple',
    texture: '/textures/project/project1.mp4',
