  ...
  return (
    <footer className="c-space pt-7 pb-3 border-t border-black-300/20 dark:border-white-800/10 backdrop-blur-xl bg-white/30 dark:bg-black-200/30">
      <div className="flex flex-col sm:flex-row justify-between items-center gap-4 sm:gap-5">
        <div className="text-gray-600 dark:text-white-500 flex gap-2 text-sm sm:text-base order-2 sm:order-1">
        ...
        <div className="flex gap-3 order-1 sm:order-2">
          ...
          <a href="https://github.com/aditya4635" target="_blank" rel="noopener noreferrer" className="social-icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16" className="text-gray-700 dark:text-white-600">
        ...
        <p className="text-gray-600 dark:text-white-500 text-sm sm:text-base text-center sm:text-right order-3">
          © {new Date().getFullYear()} Aditya Raj Bhandari.
        </p>
      </div>
      ...
      <div className="flex justify-center items-center gap-2 mt-4 text-gray-600 dark:text-white-500">
        ...
        <span className="text-sm font-medium">
          Visitors: <span className="font-bold text-accent">{visitorCount.toLocaleString()}</span>
        </span>
      </div>
    </footer>
  );
